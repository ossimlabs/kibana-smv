...
export class VegaParser {
  ...
  async _parseAsync() {
    ...
    if (!_.isPlainObject(this.spec)) {
      throw new Error(
        i18n.translate('vega.vegaParser.invalidVegaSpecErrorMessage', {
    ...
    if (this.useMap) {
      ...
      if (this.vlspec.config === undefined || (hasConfig && !this.vlspec.config.projection)) {
        ...
        if (
          ...
          throw new Error(
            i18n.translate(
              'vega.vegaParser.VLCompilerShouldHaveGeneratedSingleProtectionObjectErrorMessage',
              {
                defaultMessage:
  ...
  _calcSizing() {
    ...
    if (this.useResize && (this.spec.width || this.spec.height)) {
      if (this.isVegaLite) {
        ...
        this._onWarning(
          i18n.translate(
            'vega.vegaParser.widthAndHeightParamsAreIgnoredWithAutosizeFitWarningMessage',
            {
              defaultMessage:
  ...
  _parseControlPlacement() {
    ...
    if (this.containerDir === undefined) {
      if (this._config.controlsLocation === undefined) {
        ...
        throw new Error(
          i18n.translate('vega.vegaParser.unrecognizedControlsLocationValueErrorMessage', {
            defaultMessage:
    ...
    if (dir !== undefined && dir !== 'horizontal' && dir !== 'vertical') {
      throw new Error(
        i18n.translate('vega.vegaParser.unrecognizedDirValueErrorMessage', {
  ...
  _parseConfig() {
    ...
    if (this.spec._hostConfig !== undefined) {
      ...
      if (!_.isPlainObject(result)) {
        throw new Error(
          i18n.translate('vega.vegaParser.hostConfigValueTypeErrorMessage', {
      ...
      this._onWarning(
        i18n.translate('vega.vegaParser.hostConfigIsDeprecatedWarningMessage', {
          defaultMessage:
    ...
    if (_.isPlainObject(this.spec.config) && this.spec.config.kibana !== undefined) {
      ...
      if (!_.isPlainObject(result)) {
        throw new Error(
          i18n.translate('vega.vegaParser.kibanaConfigValueTypeErrorMessage', {
            defaultMessage: 'If present, {configName} must be an object',
  ...
  _parseTooltips() {
    ...
    if (result.position === undefined) {
      ...
      throw new Error(
        i18n.translate('vega.vegaParser.unexpectedValueForPositionConfigurationErrorMessage', {
    ...
    if (result.padding === undefined) {
      ...
      throw new Error(
        i18n.translate('vega.vegaParser.paddingConfigValueTypeErrorMessage', {
    ...
    if (result.centerOnMark === undefined) {
      ...
      throw new Error(
        i18n.translate('vega.vegaParser.centerOnMarkConfigValueTypeErrorMessage', {
  ...
  _parseMapConfig() {
    ...
    const validate = (name, isZoom) => {
      ...
      if (val !== undefined) {
        ...
        this._onWarning(
          i18n.translate('vega.vegaParser.someKibanaConfigurationIsNoValidWarningMessage', {
    ...
    if (
      ...
      res.mapStyle !== false &&
      res.mapStyle !== 'TMS in config/kibana.yml'
    ) {
      this._onWarning(
        i18n.translate('vega.vegaParser.mapStyleValueTypeWarningMessage', {
          defaultMessage: `{mapStyleConfigName} may either be {mapStyleConfigFirstAllowedValue}
            or {mapStyleConfigSecondAllowedValue} or {mapStyleConfigThirdAllowedValue}`,
          values: {
            mapStyleConfigName: 'config.kibana.mapStyle',
            mapStyleConfigFirstAllowedValue: 'false',
            mapStyleConfigSecondAllowedValue: '"default"',
            mapStyleConfigThirdAllowedValue: '"TMS in config/kibana.yml"',
          },
        })
      );
      res.mapStyle = `default`;
    ...
    if (maxBounds !== undefined) {
      if (
        ...
        this._onWarning(
          i18n.translate('vega.vegaParser.maxBoundsValueTypeWarningMessage', {
  ...
  _parseBool(paramName, dstObj, dflt) {
    ...
    if (val === undefined) {
      ...
      this._onWarning(
        i18n.translate('vega.vegaParser.someKibanaParamValueTypeWarningMessage', {
  ...
  _parseSchema() {
    if (!this.spec.$schema) {
      this._onWarning(
        i18n.translate('vega.vegaParser.inputSpecDoesNotSpecifySchemaWarningMessage', {
          defaultMessage:
    ...
    if (versionCompare(schema.version, libVersion) > 0) {
      this._onWarning(
        i18n.translate('vega.vegaParser.notValidLibraryVersionForInputSpecWarningMessage', {
          defaultMessage:
  ...
  async _resolveDataUrls() {
    ...
    this._findObjectDataUrls(this.spec, obj => {
      ...
      if (parser === undefined) {
        throw new Error(
          i18n.translate('vega.vegaParser.notSupportedUrlTypeErrorMessage', {
    ...
    if (Array.isArray(obj)) {
      ...
      if (key === 'data' && _.isPlainObject(obj.url)) {
        ...
        if (obj.values !== undefined || obj.source !== undefined) {
          throw new Error(
            i18n.translate('vega.vegaParser.dataExceedsSomeParamsUseTimesLimitErrorMessage', {
              defaultMessage:
